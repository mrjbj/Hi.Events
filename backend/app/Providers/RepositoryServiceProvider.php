...
use HiEvents\Repository\Eloquent\OrderPaymentAdjustmentRepository;
...
use HiEvents\Repository\Eloquent\OutgoingMessageEventRepository;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    private static array $interfaceToConcreteMap = [
        ...
        OrderPaymentAdjustmentRepositoryInterface::class => OrderPaymentAdjustmentRepository::class,
        ...
        OutgoingMessageEventRepositoryInterface::class => OutgoingMessageEventRepository::class,
