...
export const EventReconciliation = ({ eventId, timezone, children }: EventReconciliationProps) => {
  ...
  const waterfall = [
    ...
    { label: t`Comps/Write-offs`, value: reconciliation.comps + reconciliation.write_offs, sign: '−' as const, danger: true },
        ...
        <Card className={`${classes.card} ${classes.reconCard}`}>
          ...
          <div className={classes.tiles}>
            <div className={classes.tile}>
              <div className={classes.tileLabel}><Trans>Funds Expected (net):</Trans></div>
            ...
            <div className={classes.tile}>
              <div className={classes.tileLabel}><Trans>Funds recevied</Trans></div>
          ...
          <div className={classes.waterfall}>
            ...
            <div className={`${classes.waterfallRow} ${classes.waterfallTotal}`}>
              <div className={classes.waterfallLabel}><Trans>Funds Expected (net)</Trans></div>
              <div className={classes.waterfallBarTrack} />
            ...
            <div className={`${classes.waterfallRow} ${classes.waterfallTotal}`}>
              <div className={classes.waterfallLabel}><Trans>Funds received</Trans></div>
              <div className={classes.waterfallBarTrack} />
              <div className={classes.waterfallValue}>
            ...
            <div className={classes.waterfallRow}>
              <div className={classes.waterfallLabel}><Trans>Event expenses</Trans></div>
              <div className={classes.waterfallBarTrack} />
              <div className={classes.waterfallValue}>
                <span style={{
                  display: 'inline-flex',
